<form action="/blog_admin_demo/article" method="post">
  <fieldset>
...
?>
    ...
    <div class="<?php if (isset($errors['title'])) echo $errors['title'] ?>">
      ...
      <input id="title" name="title" value="<?php echo html::specialchars($_POST['title']) ?>"/>
    </div>

    <div class="<?php if (isset($errors['title'])) echo $errors['title'] ?>">
      <label for="body"><?php echo Kohana::lang('blog.body') ?></label>
      <textarea id="body" name="body" cols="20" rows="5"><?php echo html::specialchars($_POST['body']) ?></textarea>
    </div>

    <div>
      <label for="extended"><?php echo Kohana::lang('blog.extended_body') ?></label>
      <textarea id="extended" name="extended" cols="20" rows="15"><?php echo html::specialchars($_POST['extended']) ?></textarea>
    </div>
